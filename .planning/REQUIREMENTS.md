...
- [ ] **DIUI-01**: User sees compact state with agent count and status summary
- [ ] **DIUI-02**: User can tap Dynamic Island to expand to detailed view
- [ ] **DIUI-03**: User sees smooth animations between compact and expanded states
- [ ] **DIUI-04**: User can tap background to collapse expanded view
...
- [ ] **CORE-01**: Dynamic Island automatically expands when agent needs approval
...
- [ ] **ACCS-01**: VoiceOver announces Dynamic Island content correctly
- [ ] **ACCS-02**: Dynamic Island UI adapts to system appearance (light/dark mode)
- [ ] **ACCS-03**: Dynamic Island UI respects reduced motion accessibility setting
